  ...
  return (
    <div className="izgara">
      <section className="dosya">
        ...
        <p className="soluk">Güven beyanın gerçek doğruluğunla karşılaştırılır (kalibrasyon). Ekman & O'Sullivan 1991: emin olmak doğru olmak değildir.</p>
        <button className="birincil" disabled={!secim || d.puan !== null} onClick={gonder}>Suçlamayı ver</button>
      </section>
      <section className="dosya">
        <h2>Dayanakların</h2>
        <p className="soluk">Savcıya savun: hangi delil, hangi teknik sonucu? Sadece davranış ipuçlarına dayanıyorsan bunu bil.</p>
        {dayanaklar.map((x) => (
        ...
        <ul className="soluk">
          <li>Masum biri de aynı tepkiyi verir miydi? (Othello)</li>
          <li>Karşıt hipotezi yazdın mı? (Çapalama)</li>
          <li>Tuzak kurduysan ayrıntı sızmış mıydı? (CIT geçerliliği)</li>
