    ...
    <div className="kabuk">
      <header className="ust">
        ...
        <nav aria-label="Ekranlar">
          ...
          {vakaVar && !d.puan && <button title="Zaman 1 saat ilerler; takım yeni bilgi getirir" className={d.ekran === 'kanepe' ? 'secili' : ''} onClick={() => { if (depo.kanepeMolasi()) depo.ekranaGit('kanepe'); }}>☕ Kanepe molası</button>}
