...
const SABLONLAR: Record<string, string[]> = {
  ...
  'kendi-null': ['Hatırlamıyorum.', 'O saati çıkaramıyorum.', 'Bilmiyorum, sanırım oradan oraya gidiyordum.'],
  'baska-dogru': [
  ...
  'baska-null-dogru': ['Görmedim.', '{hedefB} o saatte görmedim.', 'Bilmiyorum, nerede olduğunu görmedim.'],
  'baska-null-dikkat': [
    'O sırada {eylem}; {hedefB} fark etmedim.',
    'Dikkat etmedim. {Eylem}.',
    'Görmüş olabilirim ama {eylem}, aklımda kalmamış.',
  ],
  'yontem-dogru': ['Duyduğum kadarıyla {yontem}.', 'Herkes "{yontem}" diyor.', 'Söylenen şu: {yontem}. Ben de öyle duydum.'],
  'yontem-null-dogru': ['Bilmiyorum.', 'Kimse bana bir şey söylemedi.', 'Hiçbir fikrim yok, gerçekten.'],
  'yontem-gizleme': ['Hiçbir fikrim yok. Bana kimse bir şey söylemedi.', 'Ne olduğunu bilmiyorum.', 'Bunu benden değil polisten öğrenmelisiniz.'],
  'fail-dogru': ['{failB} gördüm. {failAd} oradaydı.', 'Oradaki kişi {failAd}. Kendi gözlerimle gördüm.', '{failAd}. Söylemek istemezdim ama gördüm.'],
  'fail-null-dogru': ['Bilmiyorum.', 'Keşke bilseydim.', 'Kimseyi görmedim.'],
  'fail-gizleme': ['Keşke bilseydim.', 'Hiçbir fikrim yok.', 'Ben de sizin kadar şaşkınım.'],
  'fail-koruma': ['Kimseyi görmedim.', 'Görmedim, sadece sesler duydum.', 'Orada kimse yoktu.'],
  'fail-itiraf': ['Tamam… ben yaptım. Yazın: {kendiAd}.', 'Ben yaptım. {kendiAd}. Artık bırakın.', 'Evet, bendim. {kendiAd}.'],
};

const UZUN_EKLER = ['Hepsi bu.', 'Dediğim gibi.', 'Başka bir şey yok.', 'Hatırladığım bu kadar.'];
