# OYUN TASARIM TOHUMU — Fikir Bankası (v1.0)
...
1. Oyun adı ve kahramanın adı.
2. Mekân: Türkiye'de kurgusal şehir mi, yurtdışı mı?
3. Runtime'da LLM kullanılacak mı (diyalog üslubu için)? Kullanılacaksa hangi sınırlarla?
4. Platform: tarayıcı (önerilen) / masaüstü paketi.
