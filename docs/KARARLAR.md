...
## K-018 · 2026-09-18 · Türkçe metinler için MTPE turu ve üslup kılavuzu (kullanıcı isteği)
- **Karar:** Oyundaki Türkçe metinler "makine çevirisi sonrası düzenleme" (MTPE) yaklaşımıyla düzeltildi: mevcut Türkçe başlangıç noktasıdır, İngilizce kaynak yalnızca anlam ve terim doğrulaması için kullanılır, baştan çeviri yapılmaz. Ortak dil kararları `docs/USLUP.md`'de (katmanlara göre ses, biçim kuralları, ~45 terimlik sözlük). Bundan sonra eklenen her metin bu dosyaya uyar.
- **Gerekçe:** Kullanıcı (18.09.2026): metinler anlamca doğru ama "çeviri yapılmış" gibi okunuyor; İngilizce söz dizimi, sembollü telgraf üslubu, bağlamdan kopuk terimler, aynı kavramın farklı adları, oyun ve kılavuz dilinin karışması. Kök neden ortak bir terim kararının olmamasıydı; tek tek düzeltme yerine önce sözlük, sonra görünürlüğe göre katman katman düzeltme seçildi.
- **Başlıca terim kararları:** identity claim → kimlik mesajı; behavioral residue → davranış izi (odadaki alışkanlık izi / dışarıdaki hayatının izi); izlenim için düzenlenmiş oda → göstermelik düzen ("sahnelenmiş" yalnızca suç sahnesi); anchoring → çıpalama etkisi; heuristic → kısayol; representativeness → tipik suçlu yanılgısı; interpreter → içimizdeki hikâyeci; reactance → tepkisellik; witness contamination → tanığı yönlendirme; Funder RAM → dört aşama (ilgililik, erişim, fark etme, yorumlama). Hata etiketleri kavram adı olur, açıklamaları ikinci tekil geçmiş zaman.
